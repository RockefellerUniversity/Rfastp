...
The Rfastp package provides an interface to the all-in-one preprocessing for FastQ files toolkit [fastp](https://github.com/OpenGene/fastp) and toolkit removing sequencing duplications and eliminate sequencing errors by generating consensus reads [gencore](https://github.com/OpenGene/gencore).
...
## A complex quality control example, Trim poor quality bases at 3' end base by base with quality higher than 5; trim poor quality bases at 5' end by a 29bp window with mean quality higher than 20; disable the polyG trimming, specify the adapter sequence for read1.
```{r}
